...
type Problem struct {
	...
	BackgroundHtml string                 `json:"background_html" xorm:"text"`
	Statement      string                 `json:"statement" xorm:"text"`
	StatementHtml  string                 `json:"statement_html" xorm:"text"`
	Input          string                 `json:"input" xorm:"text"`
	InputHtml      string                 `json:"input_html" xorm:"text"`
	Output         string                 `json:"output" xorm:"text"`
	OutputHtml     string                 `json:"output_html" xorm:"text"`
	...
	HintHtml       string                 `json:"hint_html" xorm:"text"`
